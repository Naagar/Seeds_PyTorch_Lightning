...
data_transforms = transforms.Compose([
        ...
        transforms.RandomRotation((-270, 270)),                     ## 256
        ...
        transforms.Normalize(mean=[1.0817, 1.1146, 0.9792], std=[0.8482, 0.9573, 1.1026])  #   mean : [1.0817, 1.1146, 0.9792], std :[0.8482, 0.9573, 1.1026] , 
